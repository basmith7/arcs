...
**Current release: v0.7.1.** Keep this line current — it was four releases stale before 09-22.

What has shipped since v0.1.0, newest first: **v0.7.1** the rulebook 6.2.3 win tie-break (a tie for
